export const translations = {
  zh: {
    ...
    batch_share: {
      ...
      html: '网页 (HTML)',
      pdf: 'PDF 文档',
      images_per_page: '每页图片数',
      export: '导出',
      exporting: '正在生成...',
      export_success: '导出成功',
      export_failed: '导出失败',
      no_selection: '请先选择截图',
      selected_count: '已选 {count} 张',
      game_title: '游戏名',
      rating: '评分',
      note: '附注',
      time: '截图时间',
  ...
  en: {
    ...
    settings: {
      ...
      hotkey_hint: 'Checked keys will trigger screenshots',
    ...
    batch_share: {
      ...
      no_selection: 'Please select screenshots first',
  ...
  ja: {
    ...
    settings: {
      ...
      hotkey_hint: 'チェックしたキーでスクリーンショットを撮ります',
      system: 'システムオプション',
      autostart: '起動時に自動開始',
    ...
    batch_share: {
      ...
      html: 'ウェブページ (HTML)',
      pdf: 'PDF文書',
      images_per_page: 'ページあたりの画像数',
      export: 'エクスポート',
      exporting: '生成中...',
      export_success: 'エクスポート成功',
      export_failed: 'エクスポート失敗',
      no_selection: 'スクリーンショットを選択してください',
      selected_count: '{count}枚選択',
      game_title: 'ゲーム',
      rating: '評価',
      note: 'メモ',
      time: '撮影時間',
